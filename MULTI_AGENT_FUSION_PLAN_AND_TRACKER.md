...
| **Phase 10.5** | **Execute the Phase-10 verdicts** — 5 feature-merges, 5 arch deletions, ledger rows *(roadmap v6.0)* | `[~] IN PROGRESS — qwen3_asr (B11) + voxtral_realtime (B12 fdaa9a5) DONE; sortformer_diar NEXT` | B11–B15 revert commits filled; no shadowed GGUF arch |
