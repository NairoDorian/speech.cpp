...
| **Phase 10.5** | **Execute the Phase-10 verdicts** — 5 feature-merges, 5 arch deletions, ledger rows *(roadmap v6.0)* | `[~] IN PROGRESS — qwen3_asr DONE (B11 9cc5457); voxtral_realtime NEXT` | B11–B15 revert commits filled; no shadowed GGUF arch |
