...
| B17–B27 | `src/runtime/arch/{whisper, voxtral, canary, canary_qwen, cohere, gigaam, granite, granite_nar, medasr, moss}/` | 41,084 | `src/models/<family>/` (new directories) | per-family goldens + WER | Phase 11 | |
