...
| B31 *(v6.0)* | `models/whisper/assets.cpp` private `.bin` parser; `models/whisper/graphs.cpp` encoder | ~600 | `assets/whisper_bin_tensor_source` (Part 1 ✅ committed); `WhisperEmbeddingModule` (exists) encoder fold | `whisper_engine_smoke_test`, `whisper_bin_*` units | Phase 11a | |
