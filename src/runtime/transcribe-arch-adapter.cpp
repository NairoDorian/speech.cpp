...
// so the one overlapping name still carried there (moss) keeps its
// transcribe.cpp handler until Phase 10.5 retires it; qwen3_asr and
// voxtral_realtime were retired first, so those names resolve here alone.
